...
}:
{
  ...
  nixpkgs.overlays = [
    ...
    #       owner = "akinomyoga";
    #       repo = "ble.sh";
    #       rev = "8060b7ad6b2f66cf0f942d296de57e8d8be381f4"; # latest commit on master as of 2025-09-16
  ...
  xdg.configFile."bash" = {
    source = config.lib.file.mkOutOfStoreSymlink "${config.home.homeDirectory}/.config/home-manager/bash";
  };

  xdg.configFile."blesh" = {
    source = config.lib.file.mkOutOfStoreSymlink "${config.home.homeDirectory}/.config/home-manager/blesh";
  };
  ...
  xdg.configFile."zsh" = {
    source = config.lib.file.mkOutOfStoreSymlink "${config.home.homeDirectory}/.config/home-manager/zsh";
  };
